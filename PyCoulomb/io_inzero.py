...
def read_inzero(input_file):
    ...
    [start_gridx, finish_gridx, start_gridy, finish_gridy, xinc, yinc] = io_intxt.compute_grid_params(minlon, maxlon,
                                                                                                      minlat, maxlat,
                                                                                                      zerolat);
