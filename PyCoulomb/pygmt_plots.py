...
def annotate_figure_with_sources(fig, inputs, _mu=30e9, _fmscale="0.3c", dotstyle="s0.3c"):
    """
    ...
    :param _mu: shear modulus, float
    :param _fmscale: focal mechanism size
    ...
    # Can come back and re-draw small sources with focal mechanisms in the future
