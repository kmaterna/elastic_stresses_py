...
class Tests(unittest.TestCase):
    ...
    def test_okada_rect_vs_tri(self):
        ...
        inputs = PyCoulomb.coulomb_collections.Input_object(zerolon=zerolon, zerolat=zerolat, depth=None,
                                                            ...
                                                            source_object=[pycoulomb_rectangle], xinc=None, yinc=None)

        tri_faults = fst.fault_slip_triangle.convert_rectangle_into_two_triangles(test_rectangular_fault)
        modeled_tri_points = fst.triangle_okada.compute_disp_points_from_triangles(tri_faults, obs_disp_points,
                                                                                   test_params.nu)
